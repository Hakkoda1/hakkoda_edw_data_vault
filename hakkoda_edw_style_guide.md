...
|-------------|--------------------------------------------------------------|
| raw_stage   | <li> Contains models from sources organized by source system |
| hash_stage  | <li> Contains models from refs of raw_stage with additional </li><li> hashes and metadata columns added </li> |
| raw_vault   | <li> Contains models generated by dbtvault macros organized </li><li> by type of data vault object (i.e. hubs, links, etc) </li> |
| biz_vault   | <li> Contains models from refs of raw_vault for performance </li><li> or reusability (i.e. point-in-time table, computed satellites) </li> |
| info_mart   | <li> Contains models from raw or biz_vault transformed into </li><li> dimension model or wide tables for use by analysts </li> |
| source_mart | <li> Contains models from raw_vault transformed to represent </li><li> the original structure from the source system table or file </li> |
| unit_test   | <li> Contains models from refs used to unit test a model and </li><li> ensure it contains the correct data before creating a PR </li> |
